...
public class PlaceAutoCompleteAdapter
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            System.out.println(TAG + "Starting autocomplete query for: " + constraint);
            ...
            if (!status.isSuccess()) {
                ...
                System.out.println(TAG + "Error getting autocomplete prediction API call: " + status.toString());
                autocompletePredictions.release();
                return null;
            }

            System.out.println(TAG + "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
